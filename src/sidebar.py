...
class MySideBar(QMainWindow,Ui_MainWindow):
    ...
    def add_new_data(self):
        ...
        self.cursor.execute("CREATE TABLE IF NOT EXISTS DataTrade (fecha text,  kc_19_1_5 text, ema_12 text, ema_24 text, rsi text, sma_14 text, patrones_velas text, volumen_operaciones text,  niveles_soporte_resistencia text, indicador_volumen text, analisis_direccion_mercado text, direccion_mercado_pasado_tiempo text, cambio_porcentual text, coin text)")
        ...
        self.cursor.execute("INSERT INTO DataTrade VALUES (?, ?, ? , ?, ?, ?, ?, ?, ?, ?, ?, ?, ? , ?)", self.new_trade)
    ...
    def load_data(self):
        ...
        trades_sqlquery="SELECT * FROM DataTrade"
    ...
    def call_data(self):
        ...
        self.coin_edit = str(self.table.item(current_row_index, 6).text())        
        ...
        self.volumenOperaciones_edit=str(self.table.item(current_row_index,13).text())
        self.patronesVela_edit=str(self.table.item(current_row_index,7).text())
        self.indicadorVolumen_edit=str(self.table.item(current_row_index,9).text())
        self.nSoporteResistencia_edit=str(self.table.item(current_row_index,8).text())
        ...
        self.coin_edit=str(self.table.item(current_row_index,13).text())
        ...
        self.fechalineEdit.setText(self.fecha_edit)
        ...
        self.coinEdit.setText(self.coin_edit)
    ...
    def upload_data(self):
        ...
        self.cursor.execute("UPDATE DataTrade SET  fecha = ?, kc_19_1_5 = ?, ema_12 = ?, ema_24 = ?, rsi = ?, sma_14 = ?, volumen_operaciones = ?, patrones_velas = ?, niveles_soporte_resistencia = ?, indicador_volumen = ?, analisis_direccion_mercado = ?, direccion_mercado_pasado_tiempo = ?, cambio_porcentual = ?, coin = ? WHERE fecha = ?", params)
    ...
    def delete_data(self):
        ...
        if message == QMessageBox.StandardButton.Yes:
            sqlquery="DELETE FROM DataTrade WHERE fecha=?"
